<h1>1983 - Maximum Population Year</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/maximum-population-year/">maximum-population-year</a></h2><p>You are given a 2D integer array <code>logs</code> where each <code>logs[i] = [birth<sub>i</sub>, death<sub>i</sub>]</code> indicates the birth and death years of the <code>i<sup>th</sup></code> person.</p>
